<template>
    <div class="share-body">
        <div class="top">
            <button class="btn btn-primary" :class="[selectIdList.length > 0 ? '':'disabled']" @click="cancelShare">
                    ...
                    >
                        ...
                        <td class="filename">
                            ...
                            <div v-show="data.showOp" class="filename-right">
                                <span class="iconfont icon-link right-item" @click="copy(data)">复制链接</span>
                                <span class="iconfont icon-cancel right-item" @click="cancelShareItem(data.shareId)">取消分享</span>
                            </div>
                        </td>
