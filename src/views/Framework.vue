<template>
    <div class="framework">
                ...
                <div class="header-right">
                    <div class="collapse-all">
                        ...
                        <div class="collapse-body container">
                            <div class="collapse multi-collapse" :class="[showCollpase ? 'showCollpase':'']" id="collapseWidthExample">
                                <div class="card">
                                    <div class="card-header">
                                        <span>上传任务</span>
                                        <span class="card-header-small-title">（仅展示本次上传任务）</span>
                                        <span class="iconfont icon-del header-del" @click="clearHistory">删除所有历史记录</span>
                                    </div>
                                    <div class="card-body">
                                        <Uploader ref="upLoaderRef" 
                                        @uploadCallback="uploadCallbackHandler"></Uploader>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div v-else class="dropdown">
                        <div class="right-dropdown dropdown-toggle" data-bs-toggle="dropdown" id="dropdownMenuButton" aria-expanded="false">
                            <div class="right-img">
                                <img :src="baseurl + 'media/' + userInfo.avatar + '?timeStamp=' + timeStamp" alt="">
                            </div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="#" @click.prevent="showAvatar">修改头像</a></li>
                            <li><a class="dropdown-item" href="#" @click.prevent="showPwd">修改密码</a></li>
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">退出登陆</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="body">
            <div class="left-side" :class="[ishide?'showSide':'']">
                <div class="menu-list">
                    <template v-for="item in menus">
                        <div @click="jump(item)" :class="['menu-item',item.menuCode === currentMenu.menuCode ? 'active':'']" v-if="item.allShow || userInfo.identity">
                ...
                <div class="menu-sub-list">
                    <div
                        :class="['item-item-sub',currentPath === sub.path ? 'active':'',currentPath === sub.path ? 'item-sub-active':'']"
                    ...
                    <div class="space-info">
                        ...
                        <div class="percent row d-flex flex-nowrap">
                            <div class="col-10  m-0">
                                <div class="progress" role="progressbar" aria-label="BExample 5px high" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 10px">
                                    <div class="progress-bar" :style="{'width':(Math.floor((useSpaceInfo.useSpace / useSpaceInfo.totalSpace) * 10000) / 100) + 'px'}"></div>
                                </div>
                            </div>
                            <div class="col p-0 m-0">{{ (Math.floor((useSpaceInfo.useSpace / useSpaceInfo.totalSpace) * 10000) / 100) }}%</div>
                        </div>
                        <div class="space-refresh">
                            <div>{{formatFileSize(useSpaceInfo.useSpace)}} / {{ formatFileSize(useSpaceInfo.totalSpace) }}</div>
            ...
            <div class="body-content">
                <router-view v-slot="{ Component }">
                    <component :is="Component" ref="routeViewRef" @addFile="addFile"></component>
                </router-view>
            </div>
        ...
        <!-- 模态框组件 -->
        <UpdateAvatar ref="updataAvatar" @updateAvatar="refreshAvatar"></UpdateAvatar>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" @click="outLogin" data-bs-dismiss="modal">确定</button>
                </div>
                </div>
            </div>
        </div>
...
<script setup lang="ts">
    ...
    const setMenu:(menuCode:string,path:string)=>void = (menuCode,path) => {
        // 告诉TypeScript此处的menu是chooseMenu类型
