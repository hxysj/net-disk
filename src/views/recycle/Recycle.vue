<template>
    <div>
        <div class="top">
            <button class="btn btn-primary" :class="[selectIdList.length > 0 ? '':'disabled']" @click="recycle_select">
                <span class="iconfont icon-revert"></span>
                还原
            </button>
            <button class="btn btn-danger" :class="[selectIdList.length > 0 ? '':'disabled']" @click="delFileSelect">
                    ...
                    >
                        ...
                        <td class="filename">
                            ...
                            <div v-show="data.showOp" class="filename-right">
                                <span class="iconfont icon-revert right-item" @click="revert(data.fileId)">还原</span>
                                <span class="iconfont icon-del right-item" @click="delFile(data.fileId,data.fileName)">删除</span>
                            </div>
                        </td>
